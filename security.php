                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="password" id="simpleinput" class="form-control" value="<?php $user['password']; ?>">
                                </div>

                                <!-- password confirmation-->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Подтверждение пароля</label>
                                    <input type="password" name="password_confirmation" id="simpleinput" class="form-control" value="<?php $user['password']; ?>">
                                </div>
