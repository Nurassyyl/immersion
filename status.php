...
$status = ['Онлайн' , 'Отошел', 'Не беспокоить'];
// $status = [
//     ['status' => 'Онлайн', 'number' => 1], 
//     ['status' => 'Отошел', 'number' => 2],
//     ['status' => 'Не беспокоить', 'number' => 3]
// ];
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="status" class="form-control" id="example-select">
                                                <?php foreach ($status as $stat): ?> 
                                                    <option <?php if($stat == $user['status']): ?> selected <?php endif; ?> ><?php echo $stat; ?></option> 
