                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                <div class="form-group">
                                    <img src="uploads/<?php echo $user['avatar']; ?>" alt="" class="img-responsive" width="200">
                                </div>

                                <div class="form-group">
                                    <input type="hidden" name="id" id="example-fileinput" class="form-control-file" value="<?php echo $user['id']; ?>" >
